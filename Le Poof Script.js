//Poof Commad For KTN
//Feel Free to make edits to the messages
//made by N lel
...
function getRandMessage(user){
	...
	switch(Math.floor(Math.random()*numMessages)){
		...
		case 2: message = message + user.name + ' used Explosion!'; //owwww
			break;
		case 3: message = message + user.name + ' took a focus punch from a Breloom!';
			break;
		case 4: message = message + user.name + ' encountered A shiny Pokemon but was out of Pokeballs!';
			break;
